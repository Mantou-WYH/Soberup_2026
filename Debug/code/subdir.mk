...
code/element_line.src: ../code/element_line.c code/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc26xb "-fE:/soberup_2026/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
...
clean-code:
	-$(RM) code/element_line.d code/element_line.o code/element_line.src code/encoder.d code/encoder.o code/encoder.src code/image.d code/image.o code/image.src code/initialize.d code/initialize.o code/initialize.src code/line.d code/line.o code/line.src code/maze.d code/maze.o code/maze.src code/motor.d code/motor.o code/motor.src code/state_control.d code/state_control.o code/state_control.src code/tool.d code/tool.o code/tool.src
